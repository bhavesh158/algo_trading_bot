...
from config.settings import load_config, get_nested
from core.enums import TradingMode
from core.event_bus import EventBus
from utils.logger import setup_logging
from utils.security import validate_live_trading_prerequisites
...
class TradingSystem:
    ...
    def initialize(self) -> None:
        ...
        from reporting.alert_manager import AlertManager
